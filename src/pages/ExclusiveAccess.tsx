...
export const ExclusiveAccessPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-purple-500/5 via-background to-purple-500/10 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">
              {t('exclusiveAccess.testimonials.title')}
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {t('exclusiveAccess.testimonials.subtitle')}
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                name: t('exclusiveAccess.testimonials.client1.name'),
                location: t('exclusiveAccess.testimonials.client1.location'),
                text: t('exclusiveAccess.testimonials.client1.text'),
                rating: 5
              },
              {
                name: t('exclusiveAccess.testimonials.client2.name'),
                location: t('exclusiveAccess.testimonials.client2.location'),
                text: t('exclusiveAccess.testimonials.client2.text'),
                rating: 5
              },
              {
                name: t('exclusiveAccess.testimonials.client3.name'),
                location: t('exclusiveAccess.testimonials.client3.location'),
                text: t('exclusiveAccess.testimonials.client3.text'),
                rating: 5
              }
        ...
        <div className="container-custom">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-6">
              {t('exclusiveAccess.bottomCta.title')}
            </h3>
