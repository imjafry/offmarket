...
export const PrivateSalesPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-red-500/5 via-background to-red-500/10 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="container-custom relative">
          ...
          >
            <Link to="/become-member">
              <Button variant="ghost" size="sm" className="text-muted-foreground hover:text-red-500 hover:bg-red-500/10 transition-all">
          ...
          <div className="max-w-5xl">
            ...
            <motion.div
              ...
              className="text-center mb-16"
            >
              <Button size="lg" className="bg-red-500 hover:bg-red-600 text-white group px-8 py-4 text-lg">
                {t('privateSales.cta')}
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                >
                  <benefit.icon className="h-8 w-8 text-red-500 mx-auto mb-4" />
        ...
        <div className="container-custom">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground">
              {t('privateSales.testimonials.title')}
            </h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              {t('privateSales.testimonials.subtitle')}
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                name: t('privateSales.testimonials.client1.name'),
                location: t('privateSales.testimonials.client1.location'),
                text: t('privateSales.testimonials.client1.text'),
                rating: 5
              },
              {
                name: t('privateSales.testimonials.client2.name'),
                location: t('privateSales.testimonials.client2.location'),
                text: t('privateSales.testimonials.client2.text'),
                rating: 5
              },
              {
                name: t('privateSales.testimonials.client3.name'),
                location: t('privateSales.testimonials.client3.location'),
                text: t('privateSales.testimonials.client3.text'),
                rating: 5
              }
              ...
              >
                <Card className="h-full hover:shadow-xl transition-all duration-300 border-0 bg-gradient-to-br from-white to-gray-50 overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-red-500/10 to-red-500/5 rounded-full -translate-y-16 translate-x-16 opacity-50 group-hover:opacity-70 transition-opacity"></div>
                ...
                >
                  ...
                  <div className="pt-4">
                    <Button 
                      type="submit" 
                      size="lg"
                      className="w-full h-16 text-xl font-semibold transition-all duration-300 hover:scale-[1.02] hover:shadow-xl hover:shadow-red-500/25 disabled:hover:scale-100 bg-red-500 hover:bg-red-600"
        ...
        <div className="container-custom">
          ...
          >
            <h3 className="text-2xl md:text-3xl font-heading font-bold text-foreground mb-6">
              {t('privateSales.bottomCta.title')}
            </h3>
            <p className="text-lg text-muted-foreground mb-8">
              {t('privateSales.bottomCta.description')}
            </p>
            <Button size="lg" className="bg-red-500 hover:bg-red-600 text-white group px-8 py-4 text-lg">
              {t('privateSales.cta')}
              <Lock className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
